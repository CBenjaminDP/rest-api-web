...
export const setupAssociations = () => {
  ...
  SeccionCotizar.belongsTo(CP, { foreignKey: "id_cp", as: "cp_details" });
  CP.hasOne(SeccionCotizar, { foreignKey: "id_cp", as: "cp_details" });
  ...
  CPR.belongsTo(SeccionCotizar, {
    foreignKey: "id_prospecto",
    as: "prospect_details",
  });
  ...
  Clientes.belongsTo(TiposDePlanes, {
    foreignKey: "id_plan",
    targetKey: "id_plan",
    as: "plan_details",
  });
  TiposDePlanes.hasMany(Clientes, {
    foreignKey: "id_plan",
    sourceKey: "id_plan",
    as: "client_list",
  });
